...
CodeBuilderError ReportOperationNotSupportedForThisType( const FilePos& file_pos, U_FundamentalType type );
CodeBuilderError ReportTypesMismatch( const FilePos& file_pos, U_FundamentalType expected_type, const char* expression );
