...
define linkonce_odr float @ust_sqrt_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_sqrt_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_pow_f32_impl( float %x, float %exp ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_pow_f64_impl( double %x, double %exp ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_exp_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_exp_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_exp2_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_exp2_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_expm1_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_expm1_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_log_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_log_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_log2_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_log1p_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_log1p_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_sin_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_sin_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_cos_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_cos_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_tan_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_tan_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_asin_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_asin_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_acos_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_acos_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_atan_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_atan_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_atan2_f32_impl( float %y, float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_atan2_f64_impl( double %y, double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_floor_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_floor_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_ceil_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_ceil_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_round_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr double @ust_round_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr float @ust_trunc_f32_impl( float %x ) unnamed_addr comdat
{
