...
define linkonce_odr void @ust_memory_copy_impl( i8* %dst, i8* %src, i64 %size ) unnamed_addr comdat
{
...
define linkonce_odr void @ust_memory_copy_align_1_impl( i8* %dst, i8* %src, i64 %size ) unnamed_addr comdat
{
...
define linkonce_odr void @ust_memory_copy_align_2_impl( i8* %dst, i8* %src, i64 %size ) unnamed_addr comdat
{
...
define linkonce_odr void @ust_memory_copy_align_4_impl( i8* %dst, i8* %src, i64 %size ) unnamed_addr comdat
{
...
define linkonce_odr void @ust_memory_copy_align_8_impl( i8* %dst, i8* %src, i64 %size ) unnamed_addr comdat
{
...
define linkonce_odr void @ust_memory_copy_align_16_impl( i8* %dst, i8* %src, i64 %size ) unnamed_addr comdat
{
...
define linkonce_odr i32 @ust_memory_compare_impl( i8* %a, i8* %b, i64 %size ) unnamed_addr comdat
{
