...
define linkonce_odr hidden fastcc float @ust_sqrt_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_sqrt_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_pow_f32_impl( float %x, float %exp ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_pow_f64_impl( double %x, double %exp ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_exp_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_exp_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_exp2_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_exp2_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_expm1_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_expm1_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_log_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_log_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_log2_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_log2_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_log10_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_log10_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_log1p_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_log1p_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_sin_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_sin_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_cos_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_cos_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_tan_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_tan_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_asin_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_asin_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_acos_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_acos_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_atan_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_atan_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_atan2_f32_impl( float %y, float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_atan2_f64_impl( double %y, double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_floor_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_floor_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_ceil_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_ceil_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_round_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_round_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_trunc_f32_impl( float %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_trunc_f64_impl( double %x ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc float @ust_fma_f32_impl( float %x, float %y, float %z ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc double @ust_fma_f64_impl( double %x, double %y, double %z ) unnamed_addr comdat
{
