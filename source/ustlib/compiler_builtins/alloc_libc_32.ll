...
define linkonce_odr hidden fastcc i8* @ust_memory_allocate_impl( i32 %size ) unnamed_addr comdat
{
...
define linkonce_odr hidden fastcc i8* @ust_memory_reallocate_impl( i8* %ptr, i32 %size ) unnamed_addr comdat
{
