...
{
	%1= load atomic volatile double, double* %addr seq_cst, align 8
	ret double %1
}
...
{
	store atomic volatile double %x, double* %addr seq_cst, align 8
	ret void
}
...
{
	%1= atomicrmw volatile and i64* %x, i64 %y seq_cst
	ret i64 %1
}
...
{
	%1= atomicrmw volatile or i64* %x, i64 %y seq_cst
	ret i64 %1
}
...
{
	%1= atomicrmw volatile xor i64* %x, i64 %y seq_cst
	ret i64 %1
}
