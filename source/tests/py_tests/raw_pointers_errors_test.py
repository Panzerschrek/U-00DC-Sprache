...
def UsingIncompleteType_ForRawPointerArithmetic_Test0():
	c_program_text= """
		struct S;
		fn Foo()
		{
...
def UsingIncompleteType_ForRawPointerArithmetic_Test1():
	c_program_text= """
		struct S;
		fn Foo()
		{
...
def UsingIncompleteType_ForRawPointerArithmetic_Test2():
	c_program_text= """
		struct S;
		fn Foo()
		{
			var $( tup[i32, S, bool] ) mut ptr= zero_init;
			ptr - 55;
		}
	"""
	errors_list= ConvertErrors( tests_lib.build_program_with_errors( c_program_text ) )
...
def UsingIncompleteType_ForRawPointerArithmetic_Test3():
	c_program_text= """
		struct S;
		fn Foo()
		{
			var $( [ S, 16 ] ) mut ptr= zero_init;
			ptr - ptr;
		}
	"""
	errors_list= ConvertErrors( tests_lib.build_program_with_errors( c_program_text ) )
...
def UsingIncompleteType_ForRawPointerArithmetic_Test4():
	c_program_text= """
		struct S;
		fn Foo()
		{
...
def UsingIncompleteType_ForRawPointerArithmetic_Test5():
	c_program_text= """
		struct S;
		fn Foo()
		{
