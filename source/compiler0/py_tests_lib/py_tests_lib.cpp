...
PyObject* FilterTest( PyObject* const self, PyObject* const args )
{
	...
	static const std::unordered_set<std::string> c_tests_to_ignore
	{
		...
		"AddTooLargeIntegerToRawPointer_Test1",
		"DifferenceBetweenRawPointersWithDifferentTypes_Test0",
		"DifferenceBetweenRawPointersWithDifferentTypes_Test1",
		"DifferenceBetweenRawPointersWithZeroElementSize_Test0",
		"DifferenceBetweenRawPointersWithZeroElementSize_Test1",
		"DifferenceBetweenRawPointersWithZeroElementSize_Test2",
		"ElementTypeCompletenessIsNotRequiredForRawPointerDeclaration_Test0",
		"ElementTypeCompletenessIsNotRequiredForRawPointerDeclaration_Test1",
		"ElementTypeCompletenessIsNotRequiredForRawPointerDeclaration_Test2",
		"ExpectedReferenceValue_ForReferenceToRawPointerConversion_Test0",
		"ExpectedReferenceValue_ForReferenceToRawPointerConversion_Test1",
		"ExpectedReferenceValue_ForReferenceToRawPointerConversion_Test2",
		...
		"RawPointerAsFunctionArgument_Test0",
		"RawPointerAsFunctionArgument_Test1",
		"RawPointerAsReturnValue_Test0",
		"RawPointerAsReturnValue_Test1",
		"RawPointerAssignment_Test0",
		"RawPointerAssignment_Test1",
		"RawPointerAssignment_Test2",
		"RawPointerAssignment_Test3",
		...
		"RawPointerInitializers_Test3",
		"RawPointerInitializers_Test4",
		"RawPointerInitializers_Test5",
		...
		"RawPointerTypeIsNotConstexpr_Test3",
		"RawPointerTypeIsNotConstexpr_Test4",
		...
		"SubtractFloatFromRawPointer_Test0",
		"SubtractRawPointer_Test0",
		"SubtractRawPointer_Test1",
		"SubtructStructFromRawPointer_Test0",
		"SubtractTooLargeIntegerFromRawPointer_Test0",
		...
		"UsingIncompleteType_ForRawPointerArithmetic_Test0",
		"UsingIncompleteType_ForRawPointerArithmetic_Test1",
		"UsingIncompleteType_ForRawPointerArithmetic_Test2",
		"UsingIncompleteType_ForRawPointerArithmetic_Test3",
		"UsingIncompleteType_ForRawPointerArithmetic_Test4",
		"UsingIncompleteType_ForRawPointerArithmetic_Test5",
