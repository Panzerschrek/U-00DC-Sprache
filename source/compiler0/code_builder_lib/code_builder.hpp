...
private:
	...
	Value BuildExpressionCodeImpl( NamesScope& names_scope, FunctionContext& function_context, const Synt::SubscriptOperator& subscript_operator );
	...
	Value BuildExpressionCodeImpl( NamesScope& names_scope, FunctionContext& function_context, const Synt::IntegerNumericConstant& numeric_constant );
	Value BuildExpressionCodeImpl( NamesScope& names_scope, FunctionContext& function_context, const Synt::FloatingPointNumericConstant& numeric_constant );
	...
	Value BuildExpressionCodeImpl( NamesScope& names_scope, FunctionContext& function_context, const Synt::ExternalVariableAccess& external_variable_access );
	...
	void CheckFunctionReferencesNotationValueParamsReferencing( const FunctionType& function_type, CodeBuilderErrorsContainer& errors_container, const SrcLoc& src_loc );
