...
CallingConventionInfos CreateCallingConventionInfos( const llvm::Triple& target_triple, const llvm::DataLayout& data_layout )
{
	...
	auto default_info= std::make_shared<CallingConventionInfoDefault>( data_layout );

	calling_convention_infos[ size_t( CallingConvention::Default ) ]= default_info;
	calling_convention_infos[ size_t( CallingConvention::C ) ]= default_info; // TODO - use proper info here.
	...
	calling_convention_infos[ size_t( CallingConvention::System ) ]= default_info; // TODO - use proper info here.
