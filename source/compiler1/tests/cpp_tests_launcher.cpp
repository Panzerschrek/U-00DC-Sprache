...
bool FilterTest( const std::string& test_name )
{
	...
	static const std::unordered_set<std::string> c_test_to_enable
	{
		...
		"ReferenceCheckTest_AdditiveAssignment_0",
		"ReferenceCheckTest_AdditiveAssignment_1",
		"ReferenceCheckTest_AdditiveAssignment_2",
		"ReferenceCheckTest_AdditiveAssignmentOperatorsModifyValue",
		"ReferenceCheckTest_ArrayMemberRefersToArray_0",
		"ReferenceCheckTest_ArrayMemberRefersToArray_1",
		"ReferenceCheckTest_AssignmentForReferencedVariable_0",
		"ReferenceCheckTest_AssignmentForReferencedVariable_1",
		...
		"ReferenceCheckTest_AssignmentOperatorsModifyValue",
		...
		"ReferenceCheckTest_BinaryOperatorsModifyValue",
		"ReferenceCheckTest_DeltaOneOperatorsModifyValue_0",
		"ReferenceCheckTest_DeltaOneOperatorsModifyValue_1",
		...
		"ReferenceCheckTest_Increment_0",
		"ReferenceCheckTest_Increment_1",
		...
		"ReferenceCheckTest_ReferenceShouldLockVariableAfterConditionalReturn",
		"ReferenceCheckTest_ReturnReferenceToLocalVariable_0",
		"ReferenceCheckTest_ReturnReferenceToLocalVariable_1",
		"ReferenceCheckTest_ReturnReferenceToLocalVariable_2",
		...
		"ReferenceCheckTest_TryChangeArgs0",
		"ReferenceCheckTest_TryChangeArgs1",
		"ReferenceCheckTest_TryChangeArgs2",
		"ReferenceCheckTest_TryModifyArrayInIndexing_Test0",
		"ReferenceCheckTest_TryModifyArrayInIndexing_Test1",
		"ReferenceCheckTest_TryModifyArrayInIndexing_Test2",
