...
bool FilterTest( const std::string& test_name )
{
	...
	static const std::unordered_set<std::string> c_test_to_disable
	{
		...
		"DestructorsTest22_DestructorForTuples",
		"DestructorsTest23_DestructorForTuples",
		"DestructorsTest24_DestructorForTuples",
		"DestructorsTest25_DestructorForTuples",
		"DestructorsTest26_DestructorForTuples",
		"DestructorsTest27_DestructorForTuples",
		"ExpectedConstantExpression_InTemplateSignatureArgument_Test0",
		"ImportAccessRight_Test0",
		"ImportInClassFieldInitializer_Test0",
		"InitializerForBaseClassField_Test0",
		"InitializerForBaseClassField_Test1",
		"MethodTest6",
