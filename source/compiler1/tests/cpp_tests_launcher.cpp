...
bool FilterTest( const std::string& test_name )
{
	static const std::unordered_set<std::string> c_test_to_enable
	{
		...
		"GeneratedCopyAssignmentOperatorTest0",
		"GeneratedCopyAssignmentOperatorTest1",
		"GeneratedCopyAssignmentOperatorTest2",
		"GeneratedCopyAssignmentOperatorTest3",
		...
		"IndexationOperatorHaveFirstArgumentOfNonparentClass",
		"InvalidArgumentCountForOperator_Test",
		"InvalidReturnTypeForOperator_Test",
		...
		"OperatorDoesNotHaveParentClassArguments_Test2",
