...
bool FilterTest( const std::string& test_name )
{
	...
	static const std::unordered_set<std::string> c_test_to_enable
	{
		...
		"CopyAssignmentOperator_PollutionTest",
		...
		"DestructorsTest28_MembersDestructorCallOrder",
		"DestructorsTest29_DestructorNotCalledForReferenceField",
		"EralyTempVariablesDestruction_Test0",
		"EralyTempVariablesDestruction_Test1",
		"EralyTempVariablesDestruction_Test2",
		"EralyTempVariablesDestruction_Test3",
		"EralyTempVariablesDestruction_Test4",
		"EralyTempVariablesDestruction_Test5",
		"EralyTempVariablesDestruction_Test6",
		"EralyTempVariablesDestruction_Test7",
		"EralyTempVariablesDestruction_Test8",
		"EralyTempVariablesDestruction_Test9",
		...
		"ReferencePollutionErrorsTest_ArgReferencePollution",
		"ReferencePollutionErrorsTest_ExplicitReferencePollutionForCopyAssignmentOperator",
		"ReferencePollutionErrorsTest_ExplicitReferencePollutionForCopyConstructor",
		"ReferencePollutionErrorsTest_SelfReferencePollution",
		"ReferencePollutionTest0",
		"ReferencePollutionTest1",
		"ReferencePollutionTest2_LinkAsImmutableIfAllLinkedVariablesAreMutable",
		"ReferencePollutionTest3_LinkAsImmutableIfAllLinkedVariablesAreMutable",
		...
		"ReferncesTagsTest_ReturnReferenceToGlobalConstant1",
		"ReferncesTagsTest_TryReturnUnallowedReference0",
		"ReferncesTagsTest_TryReturnUnallowedReference1",
		...
		"ReturnStructWithReferenceFromFunction_Test0",
		"ReturnStructWithReferenceFromFunction_Test1",
		"ReturnStructWithReferenceFromFunction_Test2",
		...
		"TempVariablesMovingTest4_MoveFunctionResult",
		"TempVariablesMovingTest5_MoveInAssignment",
		"TempVariablesMovingTest6_MoveInConstructorInitializer",
		"TempVariablesMovingTest7_MoveTempVariableReturningFromFunctionToAnotherFunction",
	...
	static const std::string c_tests_to_enable_pattern[]
	{
		...
		"NameNotFoundTest",
		"NameNotFound_ForReferenceTags",
		"NameNotFound_ForTypedef_Test",
		"RecursiveCallTest",
		"Redefinition_ForTypedef_Test",
		"ReferenceClassFieldDeclaration",
		"ReferencePollutionErrorsTest_UnallowedReferencePollution_Test",
		...
		"TryGrabReferenceToTempVariable",
