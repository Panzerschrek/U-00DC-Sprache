...
bool FilterTest( const std::string& test_name )
{
	static const std::unordered_set<std::string> c_test_to_enable
	{
		...
		"ClassTemplateTest15",
		"ClassTemplateTest16",
		//"ClassTemplateTest18_DeduceAlsoTypeParameterFromValueParameter",
		"ClassTemplateTest19_StaticAssertForVariableOfTempateDependentType",
		"ClassTemplateTest20_OverloadingWithTemplateDependentType",
		"ClassTemplateTest21_CallOverloadedFunctionWithTemplateDependentSignature",
		"ClassTemplateTest22_BoolValueArgument",
		"ClassTemplateTest23_SameTemplateArgumentAppearsMultipleTimesInSignature",
		"ClassTemplateTest24_SameTemplateArgumentAppearsInMultipleFormsInSignature",
		"ClassTemplateTest25_SameTypeTemplateArgumentAppearsMultipleTimes",
		"ClassTemplateTest26_SameValueTemplateArgumentAppearsMultipleTimes",
		"DefaultSignatureArguments_Test0",
		...
		"TemplateArgumentIsNotDeducedYet_Test0",
		...
		"TypedefsTemplates_Test1",
		"TypedefsTemplates_Test2_TypedefTemplateForArray",
		"TypedefsTemplates_Test4_TypedefTemplateForArray",
		"TypedefsTemplates_Test5_ComplexSignatureArgument",
		"TypedefsTemplates_Test6_TypedefTemplateForTypedefTemplate",
		"TypedefsTemplates_Test7_ShortTypedefTemplateForm_Test0",
		"TypedefsTemplates_Test8_ShortTypedefTemplateForm_Test1",
