...
bool FilterTest( const std::string& test_name )
{
	...
	{
		"LifetimesForLambdas_Test0",
		"LifetimesForLambdas_Test1",
		"LambdaDestructor_Test0",
		"LambdaDestructor_Test1",
		"LambdaDestructor_Test2",
		"LambdaDestructor_Test3",
		"LambdaDestructor_Test4",
		"LambdasMangling_Test0",
		"LambdasMangling_Test1",
		"LambdasMangling_Test2",
		"LambdasMangling_Test3",
		"LambdasMangling_Test4",
		"LambdasMangling_Test5",
		"LambdasMangling_Test6",
		"LambdasMangling_Test7",
		"LambdasMangling_Test8",
		"LambdasMangling_Test9",
		"LambdasMangling_Test10",
		"LambdasMangling_Test11",
		"LambdasMangling_Test12",
