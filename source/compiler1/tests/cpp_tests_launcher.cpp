...
bool FilterTest( const std::string& test_name )
{
	static const std::string c_tests_to_enable_pattern[]
	{
		...
		"FunctionDeclarationOutsideItsScopeTest0",
		"FunctionDeclarationOutsideItsScopeTest1",
		"FunctionDeclarationOutsideItsScopeTest2",
		...
		"code_builder_test.cpp:ExpectedReferenceValueTest4",
		"code_builder_test.cpp:ExpectedReferenceValueTest5",
