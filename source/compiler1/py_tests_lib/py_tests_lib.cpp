...
PyObject* FilterTest( PyObject* const self, PyObject* const args )
{
	...
	{
		"ErrorInsideMixin_Test0",
		"ErrorInsideMixin_Test1",
		"ExpectedConstantExpression_ForMixins_Test0",
		"ExpectedConstantExpression_ForMixins_Test1",
		"MixinExpansionDepthReached_Test0",
		"MixinExpansionDepthReached_Test1",
		"MixinInvalidUTF8_Test0",
		"MixinInvalidUTF8_Test1",
		"MixinLexicalError_Test0",
		"MixinLexicalError_Test1",
		"MixinNamesAreNotVisibleInOtherMixinExpressions_Test0",
		"MixinNamesAreNotVisibleInOtherMixinExpressions_Test1",
		"MixinNamesAreNotVisibleInOtherMixinExpressions_Test2",
		"MixinNamesAreNotVisibleInOtherMixinExpressions_Test3",
		"MixinNamesAreNotVisibleInOtherMixinExpressions_Test4",
		"MixinRedefinition_Test0",
		"MixinRedefinition_Test1",
		"MixinRedefinition_Test2",
		"MixinRedefinition_Test3",
		"MixinSyntaxError_Test0",
		"MixinSyntaxError_Test1",
		"MixinSyntaxError_Test2",
		"MixinSyntaxError_Test3",
		"MixinSyntaxError_Test4",
		"MixinSyntaxError_Test5",
		"TypesMismatch_ForMixins_Test0",
		"TypesMismatch_ForMixins_Test1",
		"TypesMismatch_ForMixins_Test2",
		"TypesMismatch_ForMixins_Test3",
		"TypesMismatch_ForMixins_Test4",
		"ClassMixinDeclaration_Test0",
		"ClassMixinDeclaration_Test1",
		"CommentInsideMixin_Test2",
		"MacroUsageInsideMixin_Test0",
		...
		"MixinWithinMixin_Test0",
		"MixinWithinMixin_Test1",
		...
		"NamespaceMixinDeclaration_Test0",
		"NamespaceMixinDeclaration_Test1",
	};
