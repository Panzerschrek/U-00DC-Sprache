...
PyObject* FilterTest( PyObject* const self, PyObject* const args )
{
	...
	static const std::unordered_set<std::string> c_test_to_enable
	{
		...
		"FunctionTemplateBase_Test2",
		"FunctionTemplateBase_Test3",
		"FunctionTemplateDeclaration_Test0",
		"FunctionTemplateDeclaration_Test1",
		"FunctionTemplateDeclaration_Test2",
		...
		"Specialization_Test0",
		"Specialization_Test1",
		"Specialization_Test2",
		"Specialization_Test3",
		"Specialization_Test4",
		"Specialization_Test5",
		"Specialization_Test6",
		"Specialization_Test7"
		"Specialization_Test8",
		"Specialization_Test9",
		"Specialization_Test10",
		"Specialization_Test11",
		"Specialization_Test12",
		"Specialization_Test13",
		"Specialization_Test14",
		...
		"ValueIsNotTemplate_ForFunctionTemplates_Test1",
		"ValueIsNotTemplate_ForFunctionTemplates_Test2",
