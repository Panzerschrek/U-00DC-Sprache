...
PyObject* FilterTest( PyObject* const self, PyObject* const args )
{
	...
	static const std::unordered_set<std::string> c_test_to_disable
	{
		...
		"AccessingThisInLambda_Test1",
		"AccessingThisInLambda_Test2",
		"AccessingThisInLambda_Test3",
		"AccessingThisInLambda_Test4",
		"AccessingThisInLambda_Test5",
		"AccessingThisInLambda_Test6",
		"AccessingThisInLambda_Test7",
		"AccessingThisInLambda_Test8",
		"CopyAssign_ForLambdaWithReferencesInside_Test0",
		"CopyAssign_ForLambdaWithReferencesInside_Test1",
		"CopyConstructValueOfNoncopyableType_ForCapturedLambdaValue_Test0",
		"CopyConstructValueOfNoncopyableType_ForCapturedLambdaValue_Test1",
		"LambaCaptureIsNotConstexpr_Test0",
		"LambaCaptureIsNotConstexpr_Test1",
		"LambdaCapturesReferences_Test0",
		"LambdaCapturesReferences_Test2",
		"LambdaModifyCapturedVariable_Test0",
		"LambdaModifyCapturedVariable_Test1",
		"LambdaModifyCapturedVariable_Test2",
		"LambdaMoveCapturedVariable_Test0",
		"LambdaMoveCapturedVariable_Test1",
		"ReferenceFieldOfTypeWithReferencesInside_ForLambdas_Test0",
		"ReferenceFieldOfTypeWithReferencesInside_ForLambdas_Test1",
		"ReferenceNotationForLambda_Test0",
		"ReferenceNotationForLambda_Test1",
		"ReferenceNotationForLambda_Test2",
		"ReturnedFromLambdaReferenceIsLinkedToCapturedVariableInnerReference_Test0",
		"ReturnedFromLambdaReferenceIsLinkedToLambdaArg_Test0",
		"ReturnedFromLambdaReferenceIsLinkedToLambdaItself_Test0",
		"ReturnedFromLambdaReferenceIsLinkedToLambdaItself_Test1",
		...
		"LambdaCaptureAllByReference_Test0",
		"LambdaCaptureAllByReference_Test1",
		"LambdaCaptureAllByReference_Test2",
		"LambdaCaptureAllByReference_Test3",
		"LambdaCaptureAllByReference_Test4",
		"LambdaCaptureAllByReference_Test5",
		"LambdaCaptureAllByReference_Test6",
		"LambdaCaptureAllByReference_Test7",
		"LambdaCaptureAllByReference_Test8",
		"LambdaCaptureAllByReference_Test9",
		"LambdaCaptureAllByValue_Test0",
		"LambdaCaptureAllByValue_Test1",
		"LambdaCaptureAllByValue_Test2",
		"LambdaCaptureAllByValue_Test3",
		"LambdaCaptureAllByValue_Test4",
		"LambdaConstexpr_Test0",
		"LambdaConstexpr_Test1",
		"LambdaConstexpr_Test2",
		"LambdaConstexpr_Test3",
		"LambdaConstexpr_Test4",
		"LambdaConstexpr_Test5",
		"LambdaConstexpr_Test6",
		"LambdaConstexpr_Test7",
		"LambdaConstexpr_Test8",
		"LambdaConstexpr_Test9",
		"LambdaConstexpr_Test10",
		"LambdaConstexpr_Test11",
		"LambdaConstexpr_Test12",
		"LambdaInGlobalContext_Test0",
		"LambdaInGlobalContext_Test1",
		"LambdaInGlobalContext_Test2",
		"LambdaInGlobalContext_Test3",
		"LambdaMayBeCopyable_Test0",
		...
		"LambdaReferencePoillution_Test1",
		"LambdaReferencePoillution_Test2",
		"LambdaReferencePoillution_Test3",
		"LambdaTypeinfo_Test0",
		"LambdaTypeinfo_Test1",
		"LambdaTypeinfo_Test2",
		"LambdaTypeinfo_Test3",
		"LambdaTypeinfo_Test4",
		"Lambda_ReturnReferenceToCapturedVariable_Test0",
