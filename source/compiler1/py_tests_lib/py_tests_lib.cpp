...
PyObject* FilterTest( PyObject* const self, PyObject* const args )
{
	...
	static const std::string c_test_to_enable[]
	{
		...
		"ErrorsTest0",
		"ErrorsTest1",
		"FunctionPointerAsFunctionArgument_Test0",
		"FunctionPointerAsFunctionArgument_Test1",
		"FunctionPointerAsReturnValue_Test0",
		"FunctionPointerAsSpecializedTemplateParameter_Test0",
		"FunctionPointerAsSpecializedTemplateParameter_Test1",
		"FunctionPointerAsSpecializedTemplateParameter_Test2",
		"FunctionPointerCall_Test0",
		...
		"FunctionPoinerInitialization_Test3",
		"FunctionPoinerInitialization_Test4",
		"FunctionPointerReferencesIsNotCompatible_Test0",
		"FunctionPointerReferencesIsNotCompatible_Test1",
		...
		"InvalidFunctionArgumentCount_Test0",
		"InvalidFunctionArgumentCount_Test1",
		"Int128_Test0",
		"OkTest",
		"SimpliestTest",
		...
		"TypesMismatch_InFunctionPointerCall_Test0",
		"TypesMismatch_InFunctionPointerCall_Test1",
