...
PyObject* FilterTest( PyObject* const self, PyObject* const args )
{
	...
	{
		"AccessingPrivateMemberInsideClass_Test0",
		"AccessingPrivateMemberInsideClass_Test1",
		"AccessingPrivateMemberInsideClass_Test2",
		"AccessingPrivateMemberInsideClass_Test3",
		"AccessingPrivateMemberInsideClass_Test5",
		"AccessingPrivateMemberInsideClass_Test6",
		"AccessingPrivateMemberOutsideClass_ViaMemberAccessOperator_Test0",
		"AccessingPrivateMemberOutsideClass_ViaMemberAccessOperator_Test1",
		"AccessingPrivateMemberOutsideClass_Test0",
		"AccessingPrivateMemberOutsideClass_Test1",
		"AccessingPrivateMemberOutsideClass_Test2",
		"AccessingPrivateMemberOutsideClass_Test3",
		"AccessingPrivateMemberOutsideClass_Test4",
		"AccessingProtectedMember_Test0",
		"AccessingProtectedMember_Test1",
		"AccessingProtectedMember_Test2",
		"AccessingProtectedMember_Test3",
		...
		"BodyForDeletedFunction_Test0",
		"BodyForDeletedFunction_Test1",
		"BodyForGeneratedFunction_Test0",
		"BodyForGeneratedFunction_Test1",
		"BodyForPureVirtualFunction_Test0",
		"BodyForPureVirtualFunction_Test1",
		...
		"ChildClassNameOverridesParentClassNameAndVisibility_Test0",
		"ChildClassNameOverridesParentClassNameAndVisibility_Test1",
		"ChildClassNameOverridesParentClassNameAndVisibility_Test2",
		"ClassContainsPureVirtualFunctions_Test0",
		"ClassContainsPureVirtualFunctions_Test1",
		"ClassContainsPureVirtualFunctions_Test2",
		"ClassHaveNoCopyAssignementOperatorByDefault_Test0",
		"ClassHaveNoCopyConstructorByDefault_Test0",
		"ClassHaveNoCopyConstructorByDefault_Test1",
		"ClassHaveNoCopyConstructorByDefault_Test2",
		...
		"CopyChildToParent_Test0",
		"CopyChildToParent_Test1",
		"CopyChildToParent_Test2",
		"CopyChildToParent_Test3",
		...
		"DisableDefaultConstructor_Test0",
		"DisableDefaultConstructor_Test1",
		...
		"FunctionDoesNotOverride_Test0",
		"FunctionDoesNotOverride_Test1",
		"FunctionDoesNotOverride_Test2",
		...
		"InheritanceTest_BaseReference_Test0",
		"InheritanceTest_ChildClassNameOverridesParentClassName_Test0",
		"InheritanceTest_ChildClassNameOverridesParentClassName_Test1",
		"InheritanceTest_ChildClassNameOverridesParentClassName_Test2",
		"InheritanceTest_ChildClassNameOverridesParentClassName_Test3",
		"InheritanceTest_ChildClassNameOverridesParentClassName_Test4",
		"InheritanceTest_ChildClassNameOverridesParentClassName_Test5",
		"InheritanceTest_InitializeBaseClass_Test0",
		"InheritanceTest_InitializeBaseClass_Test1",
		...
		"Int128_Test0",
		"InvalidMethodForBodyGeneration_Test0",
		"InvalidMethodForBodyGeneration_Test1",
		"InvalidMethodForBodyGeneration_Test2",
		"InvalidMethodForBodyGeneration_Test3",
		"InvalidMethodForBodyGeneration_Test4",
		"InvalidTypeOfTemplateVariableArgument_ForFunctionTemplateParameter",
		"LessSpecializedTemplateTypesNotGenerated_Test0",
		"MethodBodyGenerationFailed_Test0",
		"MethodBodyGenerationFailed_Test1",
		"MethodBodyGenerationFailed_Test2",
		"MethodBodyGenerationFailed_Test3",
		"MethodBodyGenerationFailed_Test4",
		...
		"OkTest",
		"OverloadingResolutionTest_ForFunctionTemplates_Test0",
		"OverloadingResolutionTest_ForFunctionTemplates_Test1",
		"OverloadingResolutionTest_MutabilityAndReferenceConversions_Test0",
		...
		"OverloadingResolutionTest_OnlyMutabilityCheck_Test1",
		"OverloadingResolutionTest_OnlyMutabilityCheck_Test2",
		"OverloadingResolutionTest_OnlyMutabilityCheck_Test3",
		"OverloadingResolutionTest_OnlyMutabilityCheck_Test4",
		"OverloadingResolutionTest_OnlyMutabilityCheck_Test5",
		"OverloadingResolutionTest_OnlyMutabilityCheck_Test6",
		"OverloadingResolutionTest_OnlyMutabilityCheck_Test7",
		"OverloadingResolutionTest_OnlyMutabilityCheck_Test8",
		"OverloadingResolutionTest_ParentClassCall_Test0",
		"OverloadingResolutionTest_ParentClassCall_Test1",
		"OverloadingResolutionTest_ParentClassCall_Test2",
		"OverloadingResolutionTest_ReferenceConversions_Test0",
		"OverloadingResolutionTest_ReferenceConversions_Test1",
		"OverloadingResolutionTest_ReferenceConversions_Test2",
		"OverloadingResolutionTest_ReferenceConversions_Test3",
		"OverloadingResolutionTest_ReferenceConversions_Test4",
		"OverloadingResolutionTest_StaticClassFunctions_Test0",
		"OverloadingResolutionTest_StaticClassFunctions_Test1",
		"OverloadingResolutionTest_StaticClassFunctions_Test2",
		"OverloadingResolutionTest_StaticClassFunctions_Test3",
		"OverloadingResolutionTest_StaticClassFunctions_Test4",
		"OverrideFinalFunction_Test0",
		"OverrideFinalFunction_Test1",
		"OverrideRequired_Test0",
		"OverrideRequired_Test1",
		"PrivateMembersNotInherited_Test0",
		"PrivateMembersNotInherited_Test1",
		"PrivateMembersNotInherited_Test2",
		"PrivateMembersNotInherited_Test3",
		...
		"VirtualDestructor_Test0",
		"VirtualDestructor_Test1",
		"VirtualDestructor_Test2",
		"VirtualDestructor_Test3",
		"VirtualDestructor_Test4",
	...
	static const std::string c_tests_to_enable_pattern[]
	{
		...
		"InheritanceTest_ClassParentsList_Test",
