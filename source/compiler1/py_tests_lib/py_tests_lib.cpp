...
PyObject* FilterTest( PyObject* const self, PyObject* const args )
{
	...
	static const std::unordered_set<std::string> c_test_to_disable
	{
		...
		"ErrorInsideMixin_Test5",
		"ExpectedConstantExpression_ForMixins_Test4",
		"ExpectedConstantExpression_ForMixins_Test5",
		"MixinLexicalError_Test3",
		"MixinLexicalError_Test4",
		"MixinSyntaxError_Test10",
		"MixinSyntaxError_Test11",
		"MixinSyntaxError_Test12",
		"MixinSyntaxError_Test13",
		"MixinSyntaxError_Test14",
		"MixinSyntaxError_Test15",
		"MixinSyntaxError_Test16",
		"MixinSyntaxError_Test17",
		"MixinSyntaxError_Test18",
		"MixinSyntaxError_Test19",
		"ExpressionMixin_Test0",
		"ExpressionMixin_Test1",
		"ExpressionMixin_Test2",
		"ExpressionMixin_Test3",
		"ExpressionMixin_Test4",
		"ExpressionMixin_Test5",
		"ExpressionMixin_Test6",
		"ExpressionMixin_Test7",
		"ExpressionMixin_Test8",
		"ExpressionMixin_Test9",
		"TypeNameMixin_Test0",
		"TypeNameMixin_Test1",
		"TypeNameMixin_Test2",
		"TypeNameMixin_Test3",
