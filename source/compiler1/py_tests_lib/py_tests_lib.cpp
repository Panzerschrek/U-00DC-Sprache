...
PyObject* FilterTest( PyObject* const self, PyObject* const args )
{
	...
	static const std::unordered_set<std::string> c_test_to_enable
	{
		...
		"UnsafeFunctionCallInsideUnsafeBlock_Test0",
		"UnsafeFunctionCallInsideUnsafeBlock_Test1",
		"UnsafeFunctionCallInsideUnsafeBlock_Test2",
		"UnsafeFunctionCallInsideUnsafeBlock_Test3",
		"UnsafeFunctionCallInsideUnsafeBlock_Test4",
		"UnsafeFunctionCallInsideUnsafeBlock_Test5",
		"UnsafeFunctionCallOutsideUnsafeBlock_Test0",
		"UnsafeFunctionCallOutsideUnsafeBlock_Test1",
		"UnsafeFunctionCallOutsideUnsafeBlock_Test2",
		"UnsafeFunctionCallOutsideUnsafeBlock_Test3",
		"UnsafeFunctionCallOutsideUnsafeBlock_Test4",
		"UnsafeFunctionCallOutsideUnsafeBlock_Test5",
		"UnsafeFunctionCallOutsideUnsafeBlock_Test6",
		"UnsafeFunctionCallOutsideUnsafeBlock_Test7",
		"UnsafeFunctionCallOutsideUnsafeBlock_Test8",
		"UnsafeFunctionCallOutsideUnsafeBlock_Test9",
		"UnsafeFunctionCallOutsideUnsafeBlock_Test10",
		"UnsafeFunctionCallOutsideUnsafeBlock_Test11",
		"UnsafeFunctionCallOutsideUnsafeBlock_Test12",
