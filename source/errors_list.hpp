...
PROCESS_ERROR( SharedTagAdditionInInheritance, "Class \"{0}\" is marked as \"shared\" or contains \"shared\" fields but its parent \"{1}\" is not \"shared\". Changing \"shared\" property in inheritance is forbidden." )
