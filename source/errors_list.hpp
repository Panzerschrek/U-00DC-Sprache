...
PROCESS_ERROR( UnsupportedIntegerConstantType, "Unsupported integer constant type - \"{0}\"." )
PROCESS_ERROR( UnsupportedFloatingPointConstantType, "Unsupported floating point constant type - \"{0}\"." )
PROCESS_ERROR( IntegerConstantOverflow, "Integer constant {0} can't fit into type \"{1}\"." )
PROCESS_ERROR( UnknownStringLiteralSuffix, "Unknown string literal suffix - \"{0}\"." )
PROCESS_ERROR( UnknownCharLiteralSuffix, "Unknown char literal suffix - \"{0}\"." )
PROCESS_ERROR( CharLiteralOverflow, "Char literal \"{0}\" can't fit into given char type." )
...
PROCESS_ERROR( EnumsHaveConstructorsWithExactlyOneParameter, "Enums have constructors with exactly one parameter." )
PROCESS_ERROR( RawPointersHaveConstructorsWithExactlyOneParameter, "Raw pointers have constructors with exactly one parameter." )
PROCESS_ERROR( FunctionPointersHaveConstructorsWithExactlyOneParameter, "Function pointers have constructors with exactly one parameter." )
...
PROCESS_ERROR( AccessingFieldWithMutableReferencesInDestructor, "Accessing field with mutable references inside in destructor." )
...
PROCESS_ERROR( InnerReferenceTagsForReferenceField, "Inner reference tags for a reference field \"{0}\"." )
...
PROCESS_ERROR( ReferencingValueParam, "Specifying reference to a value param {0}, which isn't allowed." )
...
PROCESS_ERROR( UselessNodiscardForMethod, "\"nodiscard\" specifier for this method is useless." )
...
PROCESS_ERROR( NonSyncVariableIsAliveAtSuspensionPointOfCoroutineNotMarkedAsNonSync, "Variabe \"{0}\" having \"non_sync\" type is alive at a coroutine suspension point and this coroutine is not marked as \"non_sync\"." )
