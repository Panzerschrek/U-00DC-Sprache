...
QueuedServerHandler::QueuedServerHandler( std::ostream& log )
	: log_(log)
{
}
...
std::optional<RequestParams> QueuedServerHandler::ProcessInitialize( const Json::Value& params )
{
	(void)params;
	return Requests::Initialize{};
}

std::optional<RequestParams> QueuedServerHandler::ProcessTextDocumentSymbol( const Json::Value& params )
{
...
std::optional<RequestParams> QueuedServerHandler::ProcessTextDocumentReferences( const Json::Value& params )
{
	const auto obj= params.getAsObject();
	if( obj == nullptr )
	{
...
std::optional<RequestParams> QueuedServerHandler::ProcessTextDocumentDefinition( const Json::Value& params )
{
	const auto obj= params.getAsObject();
	if( obj == nullptr )
	{
...
std::optional<RequestParams> QueuedServerHandler::ProcessTextDocumentCompletion( const Json::Value& params )
{
	const auto obj= params.getAsObject();
	if( obj == nullptr )
	{
...
std::optional<RequestParams> QueuedServerHandler::ProcessTextDocumentHighlight( const Json::Value& params )
{
	const auto obj= params.getAsObject();
	if( obj == nullptr )
	{
...
std::optional<Notification> QueuedServerHandler::ProcessTextDocumentDidOpen( const Json::Value& params )
{
	const auto obj= params.getAsObject();
	if( obj == nullptr )
	{
...
std::optional<Notification> QueuedServerHandler::ProcessTextDocumentDidClose( const Json::Value& params )
{
	const auto obj= params.getAsObject();
	if( obj == nullptr )
	{
...
std::optional<Notification> QueuedServerHandler::ProcessTextDocumentDidChange( const Json::Value& params )
{
	const auto obj= params.getAsObject();
	if( obj == nullptr )
	{
...
std::optional<Notification> QueuedServerHandler::ProcessCancelRequest( const Json::Value& params )
{
	const auto obj= params.getAsObject();
	if( obj == nullptr )
	{
	...
	{
		log_ << "Failed to parse request id!" << std::endl;
		return std::nullopt;
	}
