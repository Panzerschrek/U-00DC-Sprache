...
Целочисленные литералы со значением больше 340282366920938463463374607431768211455 (2\ :sup:`128` - 1) не поддерживаются.
...
Кроме того существуют суффиксы ``u`` для типов ``u32``, ``u64`` или ``u128`` (в зависимости от размера литерала) и ``s`` для типа ``size_type``.
