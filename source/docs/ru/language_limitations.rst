...
Единственное исключение - глобальные переменные типов сырых указателей с ``zero_init`` инициализатором.

Данное ограничение делает невозможным простую реализацию сложных глобальных изменяемых объектов.
Но возможно, например, использование индирекции - через сырой указатель, который указывает на объект, выделенный где-то ещё.
