...
* они не должны иметь явно обоначенных конструкторов копирования, копирующих операторов присваивания, деструкторов
...
.. code-block:: u_spr
   ...
   var i32 mut nonconst= 0; // хоть инициализатор и константный, переменая константной не будет
