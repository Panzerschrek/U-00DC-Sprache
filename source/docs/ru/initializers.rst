...
Для массивов возможно указать ``...`` после последнего инициализатора элемента.
Это позволяет проинициализировать оставшийся массив с помощью него.

.. code-block:: u_spr

   var [ i32, 5 ] arr[ 5, 7, 9 ... ]; // Будет массив с содержимым 5, 7, 9, 9, 9.
