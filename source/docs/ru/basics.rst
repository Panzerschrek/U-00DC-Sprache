...
Ü поддерживает написание программ в объектно-ориентированной парадигме, позволяет писать обобщённый код, имеет элементы функционального программирования.
