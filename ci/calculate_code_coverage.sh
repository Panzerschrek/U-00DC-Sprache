...
mkdir build_dir &&\
cd build_dir &&\
cmake ../source/ -G Ninja -DCMAKE_BUILD_TYPE=Debug -DLLVM_LIB_DIR=../clang+llvm-15.0.6-x86_64-linux-gnu-ubuntu-18.04/lib/ -DU_BUILD_COMPILER2=YES -DU_BUILD_COMPILER3=NO -DU_BUILD_DOCS=NO -DU_COVERAGE_ENABLED=YES &&\
\
cmake --build . &&\
\
# Run ustlib tests
