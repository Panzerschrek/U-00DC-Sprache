...
cmake ../source/ -G Ninja -DCMAKE_BUILD_TYPE=Debug -DLLVM_LIB_DIR=$PWD/../clang+llvm-17.0.6-x86_64-linux-gnu-ubuntu-22.04/lib/ -DU_BUILD_COMPILER=NO -DU_BUILD_DOCS=NO -DU_COVERAGE_ENABLED=YES &&\
\
cmake --build . &&\
\
