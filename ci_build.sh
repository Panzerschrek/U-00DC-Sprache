...
mkdir build-travis &&\
cd build-travis &&\
cmake ../source/ -DCMAKE_BUILD_TYPE=Release -DBOOST_ROOT=../boost_1_71_0 -DLLVM_LIB_DIR=../clang+llvm-9.0.0-x86_64-linux-gnu-ubuntu-16.04/lib/ -DSPHINX_WARNINGS_AS_ERRORS=No &&\
\
# Build it
